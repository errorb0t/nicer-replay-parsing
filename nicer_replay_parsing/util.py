...
_LOCALIZED_BATTLEGROUND_DICT = {
    ...
    "AzmoDUNK!": Battleground.AZMODUNK,
    "AzmoDUNK Brawl": Battleground.AZMODUNK,
    "¡Azmodunk!": Battleground.AZMODUNK,
    "contienda AzmoDunk": Battleground.AZMODUNK,
    "choc AsmoDUNK": Battleground.AZMODUNK,
    "Rissa Azmodunk": Battleground.AZMODUNK,
    "아즈모덩크 난투": Battleground.AZMODUNK,
    "Władcy Wsadów": Battleground.AZMODUNK,
    "Contenda do Azmodan Cestinha": Battleground.AZMODUNK,
    ...
    "Schwarzherz' Rache": Battleground.BLACKHEARTS_REVENGE,
    "Blackheart's Revenge": Battleground.BLACKHEARTS_REVENGE,
    "Venganza de Almanegra": Battleground.BLACKHEARTS_REVENGE,
    "La venganza de Almanegra": Battleground.BLACKHEARTS_REVENGE,
    "La Vengeance de Cœur-Noir": Battleground.BLACKHEARTS_REVENGE,
    "Vendetta di Cuornero": Battleground.BLACKHEARTS_REVENGE,
    "블랙하트의 복수": Battleground.BLACKHEARTS_REVENGE,
    "Zemsta Czarnosercego": Battleground.BLACKHEARTS_REVENGE,
    "Vingança do Coração Negro": Battleground.BLACKHEARTS_REVENGE,
    "Месть Черносерда": Battleground.BLACKHEARTS_REVENGE,
    "黑心船长的复仇": Battleground.BLACKHEARTS_REVENGE,
    "黑心船長的復仇": Battleground.BLACKHEARTS_REVENGE,
    "Kampfrausch": Battleground.BLOODLUST_BRAWL,
    "Bloodlust Brawl": Battleground.BLOODLUST_BRAWL,
    "¡Ansia de sangre!": Battleground.BLOODLUST_BRAWL,
    "Contienda Ansia de sangre": Battleground.BLOODLUST_BRAWL,
    "Furie sanguinaire": Battleground.BLOODLUST_BRAWL,
    "Brama di Sangue": Battleground.BLOODLUST_BRAWL,
    "피의 욕망 난투": Battleground.BLOODLUST_BRAWL,
    "Bójka Żądnych Krwi": Battleground.BLOODLUST_BRAWL,
    "Contenda da Sede de Sangue": Battleground.BLOODLUST_BRAWL,
    ...
    "Checkpunkt: Hanamura": Battleground.CHECKPOINT_HANAMURA,
    ...
    "Verteidigung von Deadman's Port": Battleground.DEADMANS_STAND,
    "Deadman's Stand": Battleground.DEADMANS_STAND,
    "Fortín del Muerto": Battleground.DEADMANS_STAND,
    "Fortín del muerto": Battleground.DEADMANS_STAND,
    "Le baroud du mort": Battleground.DEADMANS_STAND,
    "Resistenza a Deadman's Port": Battleground.DEADMANS_STAND,
    "망자의 싸움터": Battleground.DEADMANS_STAND,
    "Bastion Umarlaka": Battleground.DEADMANS_STAND,
    "Resistência do Morto": Battleground.DEADMANS_STAND,
    "Мертвецкий рубеж": Battleground.DEADMANS_STAND,
    "亡者卫城": Battleground.DEADMANS_STAND,
    "死守亡人港": Battleground.DEADMANS_STAND,
    "Verteidigung von Deadman's Port (Heroisch)": Battleground.DEADMANS_STAND_HEROIC,
    "Deadman's Stand (Heroic)": Battleground.DEADMANS_STAND_HEROIC,
    "Fortín del Muerto (heroico)": Battleground.DEADMANS_STAND_HEROIC,
    "Fortín del muerto (Heroico)": Battleground.DEADMANS_STAND_HEROIC,
    "Le baroud du mort (héroïque)": Battleground.DEADMANS_STAND_HEROIC,
    "Resistenza a Deadman's Port (Eroica)": Battleground.DEADMANS_STAND_HEROIC,
    "망자의 싸움터 (영웅 난이도)": Battleground.DEADMANS_STAND_HEROIC,
    "Heroiczny Bastion Umarlaka": Battleground.DEADMANS_STAND_HEROIC,
    "Resistência do Morto (Heroica)": Battleground.DEADMANS_STAND_HEROIC,
    ...
    "브락시스 탈출 (영웅 난이도)": Battleground.ESCAPE_FROM_BRAXIS_HEROIC,
    ...
    "Gartenarena": Battleground.GARDEN_ARENA,
    "Garden Arena": Battleground.GARDEN_ARENA,
    "¡Enzarzados!": Battleground.GARDEN_ARENA,
    "Arena del Jardín": Battleground.GARDEN_ARENA,
    "L’arène des jardins": Battleground.GARDEN_ARENA,
    "Arena: Giardini": Battleground.GARDEN_ARENA,
    "정원 투기장": Battleground.GARDEN_ARENA,
    "Arena Ogrodowa": Battleground.GARDEN_ARENA,
    "Arena do Jardim": Battleground.GARDEN_ARENA,
    "Арена Сада ужасов": Battleground.GARDEN_ARENA,
    "花园竞技场": Battleground.GARDEN_ARENA,
    "花園競技場": Battleground.GARDEN_ARENA,
    ...
    "Ghost-Protokoll": Battleground.GHOST_PROTOCOL,
    "Ghost Protocol": Battleground.GHOST_PROTOCOL,
    "Protocolo fantasma": Battleground.GHOST_PROTOCOL,
    "Protocole fantôme": Battleground.GHOST_PROTOCOL,
    "Protocollo Fantasma": Battleground.GHOST_PROTOCOL,
    "유령 프로토콜": Battleground.GHOST_PROTOCOL,
    "Kryptonim: Duch": Battleground.GHOST_PROTOCOL,
    "Protocolo Fantasma": Battleground.GHOST_PROTOCOL,
    'Протокол "Призрак"': Battleground.GHOST_PROTOCOL,
    "幽灵协议": Battleground.GHOST_PROTOCOL,
    "幽靈行動": Battleground.GHOST_PROTOCOL,
    "Schlotternächte": Battleground.HALLOWS_END,
    "Hallow's End": Battleground.HALLOWS_END,
    "Halloween": Battleground.HALLOWS_END,
    "Sanssaint": Battleground.HALLOWS_END,
    "Veglia delle Ombre": Battleground.HALLOWS_END,
    "할로윈 축제": Battleground.HALLOWS_END,
    "Zaduszników": Battleground.HALLOWS_END,
    "Noturnália": Battleground.HALLOWS_END,
    "Тыквовин": Battleground.HALLOWS_END,
    "万圣节": Battleground.HALLOWS_END,
    "萬鬼節": Battleground.HALLOWS_END,
    "Hammerhart": Battleground.HAMMER_TIME,
    "Hammer Time": Battleground.HAMMER_TIME,
    "Para Martillo, todo son clavos": Battleground.HAMMER_TIME,
    "¡Mazazo!": Battleground.HAMMER_TIME,
    "Marteau-pilon": Battleground.HAMMER_TIME,
    "Sergente onnipresente": Battleground.HAMMER_TIME,
    "월드 오브 전차": Battleground.HAMMER_TIME,
    "Niezła Petarda": Battleground.HAMMER_TIME,
    "Hora da Marretada": Battleground.HAMMER_TIME,
    "Между молотом и... молотом": Battleground.HAMMER_TIME,
    "坦克大战": Battleground.HAMMER_TIME,
    "榔頭對對碰": Battleground.HAMMER_TIME,
    ...
    "Heroes of the Stars": Battleground.HEROES_OF_THE_STARS,
    "Héroes de las Estrellas": Battleground.HEROES_OF_THE_STARS,
    "Héros des étoiles": Battleground.HEROES_OF_THE_STARS,
    "스타크래프트의 영웅들": Battleground.HEROES_OF_THE_STARS,
    "Bohaterowie z Gwiazd": Battleground.HEROES_OF_THE_STARS,
    "Heróis das Estrelas": Battleground.HEROES_OF_THE_STARS,
    "Звездные герои": Battleground.HEROES_OF_THE_STARS,
    "星际英雄": Battleground.HEROES_OF_THE_STARS,
    "星海英雄": Battleground.HEROES_OF_THE_STARS,
    ...
    "Mondfest-Raketenrennen": Battleground.LUNAR_ROCKET_RACING,
    "Lunar Rocket Racing": Battleground.LUNAR_ROCKET_RACING,
    "Carrera de cohetes lunares": Battleground.LUNAR_ROCKET_RACING,
    "Carrera de cohete lunar": Battleground.LUNAR_ROCKET_RACING,
    "La piste aux fusées": Battleground.LUNAR_ROCKET_RACING,
    "Corsa sui Razzi Lunari": Battleground.LUNAR_ROCKET_RACING,
    "달의 축제 로켓 경주": Battleground.LUNAR_ROCKET_RACING,
    "Księżycowe Wyścigi Rakietowe": Battleground.LUNAR_ROCKET_RACING,
    "Corrida de Foguetes Lunares": Battleground.LUNAR_ROCKET_RACING,
    "Лунная гонка": Battleground.LUNAR_ROCKET_RACING,
    "闹新春火箭竞速赛": Battleground.LUNAR_ROCKET_RACING,
    "賀歲沖天飛車大賽": Battleground.LUNAR_ROCKET_RACING,
    "Krieg der Magier": Battleground.MAGE_WARS,
    "Mage Wars": Battleground.MAGE_WARS,
    "Guerra de magos": Battleground.MAGE_WARS,
    "Guerra arcana": Battleground.MAGE_WARS,
    "Guerre de mages": Battleground.MAGE_WARS,
    "Guerra dei Maghi": Battleground.MAGE_WARS,
    "마법 전쟁": Battleground.MAGE_WARS,
    "Wojny Magów": Battleground.MAGE_WARS,
    "Guerras de Magos": Battleground.MAGE_WARS,
    ...
    "Bestraferarena": Battleground.PUNISHER_ARENA,
    "Punisher Arena": Battleground.PUNISHER_ARENA,
    "Arena de los castigadores": Battleground.PUNISHER_ARENA,
    "Arena del castigador": Battleground.PUNISHER_ARENA,
    "L’arène des dominateurs": Battleground.PUNISHER_ARENA,
    "Arena: Punitori": Battleground.PUNISHER_ARENA,
    "응징자 투기장": Battleground.PUNISHER_ARENA,
    "Arena Pogromców": Battleground.PUNISHER_ARENA,
    "Arena do Algoz": Battleground.PUNISHER_ARENA,
    "Арена Карателей": Battleground.PUNISHER_ARENA,
    "惩罚者竞技场": Battleground.PUNISHER_ARENA,
    "暴虐魔競技場": Battleground.PUNISHER_ARENA,
    "Sandbox (Verfluchtes Tal)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Sandbox (Cursed Hollow)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Terreno de pruebas (Cuenca Maldita)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Sandbox (Hondonada maldita)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Bac à sable (Le val maudit)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Sandbox (Valle Maledetta)": Battleground.SANDBOX_CURSED_HOLLOW,
    "샌드박스 (저주받은 골짜기)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Sandbox (Przeklęta Kotlina)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Mapa Fechado (Clareira Maldita)": Battleground.SANDBOX_CURSED_HOLLOW,
    "Песочница (Проклятая лощина)": Battleground.SANDBOX_CURSED_HOLLOW,
    "沙盒（诅咒谷）": Battleground.SANDBOX_CURSED_HOLLOW,
    "試驗模式（詛咒谷地）": Battleground.SANDBOX_CURSED_HOLLOW,
    "Sandbox (Volskaya-Fertigung)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Sandbox (Volskaya Foundry)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Terreno de pruebas (Fundición de Volskaya)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Sandbox (Fundición de Volskaya)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Bac à sable (La fonderie Volskaya)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Sandbox (Fonderia Volskaya)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "샌드박스 (볼스카야 공장)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Sandbox (Odlewnia Volskaya Industries)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Mapa Fechado (Fundição Volskaya)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "Песочница (Завод Вольской)": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "沙盒（沃斯卡娅铸造厂）": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    "試驗模式（伏斯凱亞鑄造廠）": Battleground.SANDBOX_VOLSKAYA_FOUNDRY,
    ...
    "Schneeballschlacht": Battleground.SNOW_BRAWL,
    "Snow Brawl": Battleground.SNOW_BRAWL,
    "Combate bajo cero": Battleground.SNOW_BRAWL,
    "Contienda nevada": Battleground.SNOW_BRAWL,
    "Choc au sommet": Battleground.SNOW_BRAWL,
    "Rissa nella Neve": Battleground.SNOW_BRAWL,
    "눈싸움 난투": Battleground.SNOW_BRAWL,
    "Bójka na Śnieżki": Battleground.SNOW_BRAWL,
    "Contenda na Neve": Battleground.SNOW_BRAWL,
    "Потасовка со снежками": Battleground.SNOW_BRAWL,
    "雪球乱斗": Battleground.SNOW_BRAWL,
    "雪球大亂鬥": Battleground.SNOW_BRAWL,
    ...
    "L’arène des temples": Battleground.TEMPLE_ARENA,
    "Arena: Tempio": Battleground.TEMPLE_ARENA,
    "사원 투기장": Battleground.TEMPLE_ARENA,
    "Arena Świątynna": Battleground.TEMPLE_ARENA,
    "Arena do Templo": Battleground.TEMPLE_ARENA,
    "Арена Небесного храма": Battleground.TEMPLE_ARENA,
    "神殿竞技场": Battleground.TEMPLE_ARENA,
    ...
    "Stiftung Waffentest": Battleground.TRIAL_GROUNDS,
    "Trial Grounds": Battleground.TRIAL_GROUNDS,
    "Campo de pruebas": Battleground.TRIAL_GROUNDS,
    "Terrenos de prueba": Battleground.TRIAL_GROUNDS,
    "Le terrain d’entraînement": Battleground.TRIAL_GROUNDS,
    "Zona di Addestramento": Battleground.TRIAL_GROUNDS,
    "시험의 땅": Battleground.TRIAL_GROUNDS,
    "Pola Próby": Battleground.TRIAL_GROUNDS,
    "Campos de Prova": Battleground.TRIAL_GROUNDS,
    "Испытательный полигон": Battleground.TRIAL_GROUNDS,
    "试炼场": Battleground.TRIAL_GROUNDS,
    "試煉場": Battleground.TRIAL_GROUNDS,
