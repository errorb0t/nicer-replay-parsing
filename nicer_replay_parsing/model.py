...
class Battleground(Enum):
    ...
    AZMODUNK = ("AzmoDUNK Brawl", 3)
    BASH_EM_SMASH_EM = ("Bash 'Em Smash 'Em Robots", 0)
    BATTLEFIELD_OF_ETERNITY = ("Battlefield of Eternity", 2)
    BLACKHEARTS_BAY = ("Blackheart's Bay", 3)
    BLACKHEARTS_REVENGE = ("Blackheart's Revenge", 0)
    BLOODLUST_BRAWL = ("Bloodlust Brawl", 0)
    BOOTY_COFFERS = ("Booty Coffers", 0)
    ...
    SPECIAL_DELIVERY = ("Special Delivery", 0)
    TEMPLE_ARENA = ("Temple Arena", 0)
    TOMB_OF_THE_SPIDER_QUEEN = ("Tomb of the Spider Queen", 3)
    TOWERS_OF_DOOM = ("Towers of Doom", 3)
    TRIAL_GROUNDS = ("Trial Grounds", 0)
